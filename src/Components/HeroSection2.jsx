    ...
    <>
      <div className="hero2-overall">
        ...
        <p className='hero2-subheading'>
          Believing in total automation, Quizgen allows you to turn paragraphs into several multiple-choice questions with ease. All it takes is one click, a few rearrangements and you are good to go. 
        </p>
        <h1 className='hero2-heading'>
          Who is it for?
        </h1>
        ...
        <p className='hero2-subheading' style={{margin: '0 18%'}}>
          ...
          Quizgen uses AI algorithms to mimic the human MCQ creation process.
        </p>
